<section class="produit">
    ...
    <div class="table">
        ...
        ?>
            ...
            <div class="card">
                ...
                <img class="imgproduit" src="<?= Config2::$baseUrlimg . $produit->getImage() ?>" alt="Images Produits The Chic'N"></img>
                ...
                <div class="hovered">Réservation<br> au <br> 07.66.37.19.12</div>
                ...
                ?>
                    <a href="<?= Config::$baseUrl ?>/produit/modifier/<?php echo $produit->getId(); ?>" class="btn btn-info">Modifier</a>

                    <a href="<?= Config::$baseUrl ?>/produit/supprimer/<?php echo $produit->getId(); ?>" class="btn btn-danger">Supprimer</a>
                <?php
    ...
    <section class="part2">
        ...
        <h4> THE CHIC'N c'est aussi, bien d'autres produits uniquements disponibles sur commande : </h4>
